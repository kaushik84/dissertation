...
Analog to the sensing channel, the SR performs received power-based estimation by listening to the transmission from the PT. The knowledge of $\phpt$ is required to characterize the interference from the PT. 

Under $\mathcal H_1$, in the estimation phase, the discrete and complex signal received at the SR is given as 
\begin{align}
