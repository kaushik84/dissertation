...
\draw[black,thick,<->] (0.084,0.25) --  node[above, font=\small] {Power-limited} (0.367,0.25);
\draw[black,thick,<->] (0.084,0.22) --  (0.667,0.22);

\draw (0.7,0.105) arc(-160:160:0.01 and 0.03);
\draw[black,thick,<->] (0.37,0.13) --  node[above, font=\small] {Interference-limited} (0.965,0.13);
...
\draw[black,thick,<->] (0.084,0.25) --  node[above, font=\small] {Power-limited} (0.313,0.25);
\draw[black,thick,<->] (0.084,0.22) --  (0.27,0.22);

\draw (0.7,0.105) arc(-160:160:0.01 and 0.03);
\draw[black,thick,<->] (0.32,0.13) --  node[above, font=\small] {Interference-limited} (0.965,0.13);
