...
%\vspace{-4mm}
\caption{
An illustration of the performance bound ($\snrrcvdu^*$) for the US depicted in terms of estimation time ($\test$) and the ratio of the received power (from the PR) to noise ($\snrrcvdu$) at the ST. It further classifies the operation of the USs as the interference-limited and the power-limited regimes.}
\label{fig_US:or}
%\vspace{-10mm}
\end{figure}
