...
In the downlink, during data transmission phase, the interference signal received (from the ST) plus noise signal at the PR is given by
\begin{equation}
