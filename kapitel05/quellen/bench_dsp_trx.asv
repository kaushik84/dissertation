...
set(ax1,'XTickLabel',num2str((round(str2num(get(ax1,'XTickLabel'))*100))/100));
...
set(ax2,...
    ...
    'XTickLabel',num2str((round(str2num(get(ax1,'XTickLabel'))/rel*100))/100));
set(get(ax2,'YLabel'),'String','')
set(get(ax2,'XLabel'),'String','Relation to transceiver')

x_ticks = (str2num(get(ax1,'XTickLabel')));
...
print -dpdf -f1 ..\figures\bench_dsp_trx.pdf
