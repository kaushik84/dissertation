...
As a result, $\ehs$ conditioned on $\hs$ follows a Gaussian distribution
%\begin{align*}
...
In this view, the SR estimates received power by listening to the control-based transmissions from the PT, cf. \figurename~\ref{fig_HS:fs}. Similar to the sensing channel, the cdf of the estimated interference power received $\eprcvdsr$ at the ST is characterized as
\begin{align}
