...
\begin{equation}
	\label{eq:cdf}
	\fprcvdpr(x) = Q_{\frac{N}{2}}\left(\sqrt{\frac{N  \hpo}{\sigma_\textrm{p}^2}},\sqrt{\frac{N \alpha_\textrm{p} \theta_\textrm{I} K}{\sigma_\textrm{p}^2 x}}\right) \;  ,
\end{equation}
