...
\begin{figure}
	...
	\caption{(a) An illustration of a CSC scenario demonstrating an underlay paradigm. (b) Frame structure from the perspective of the ST that presents a time duration ($\test$) allocated within the frame duration for the estimation of the interference channel.} 
	\label{fig:scenario}
	%\vspace{-10 pt}
\end{figure}
