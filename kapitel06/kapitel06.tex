...
In this regard, the estimated channel gain, evaluated from $\eprcvd$, is determined as 
	...
	\end{equation}	
As $\npp$ is negligible compared to $\eprcvd$, (\ref{eq_HVD:approx1}) can be further simplified as 
	\begin{equation}
