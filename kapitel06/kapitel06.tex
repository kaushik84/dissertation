...
\begin{figure}
	...
	\begin{tikzpicture}[scale=1]
			...
			\includegraphics[width=0.94 \textheight, angle = 90]{figures/BlockDiagram_Demo}
                ...
                \node[draw, fill=gray!10, font=\scriptsize, rotate = 90, align = center] at (-0.10,0.51) {Software Defined Platform};
	
		% Transmit and receive signals	
		\node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.03,0.28) {Rx Signal};
                \node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.16,0.28) {Tx Signal};
                \node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.03,0.72) {Tx Signal};
                \node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.16,0.72) {Rx Signal};
		% Channels
                \node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.00,0.51) {$\hpo$};
                \node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.13,0.51) {$\hpt$};
		% Fill Empty Boxes
		% PR Interface
		\node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.514,0.13) {Pilot Signal \\ $(\ptran)$};
                \node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.81,0.13) {$\sum |\cdot|^2$ \\ $(= \eprcvdpr)$};
                \node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.81,0.268) {1000 \\ Measurements};
                \node[draw, fill=gray!10, font=\scriptsize, rotate = 90, align = center] at (0.95,0.268) {Buffer};
                \node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.81,0.41) {Compute $\pco$};
                
		% ST Interface
		\node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.514,0.885) {Compute $\pco$};
                \node[draw=none, font=\scriptsize, rotate = 90, align = center] at (0.81,0.885) {Compute $\pco$};
		\end{scope}
        \end{tikzpicture}
