...
Motivated by this fact, this chapter, which is based on \citeK{Kaushik15}, demonstrates the hardware feasibility of the CSC-BS as a CR system. As a result, it complements the performance analysis by deploying the proposed channel estimation techniques on a hardware. By doing this, the applicability of the assumptions considered while deriving the analytical expressions can be examined. These investigations are essential to facilitate the evolution of the proposed analytical framework. Without any specific argumentation, an underlay system is considered for the deployment.    
