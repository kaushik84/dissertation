...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Recruitment team}{Sony Deutschland GmbH, \\ Hedelfinger Strasse 61, \\70327 Stuttgart, Germany}
\jobref{Job Number: 00011939 -- Research Engineer (Signal processing and algorithms for radar)}
