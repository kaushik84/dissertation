...
\hyphenation{centra-lity knowl-edge throu-ghput fra-mework domi-nant esti-mation-throughput gro-wth Indoor-versorgung Funkzugangs-netzen}
...
\hspace{.2cm}
%\centerin}g
\centerline{\includegraphics[scale=0.95]{../stuff/title_page}}
\end{figure}
%\thispagestyle{empty}
%\begin{center}
%  \makebox[\textwidth]{\includegraphics[width=\paperwidth]{../stuff/title}}
%\end{center}
...
\input{../attachments/students.tex}
\cleardoublepage

\printindex % index
\cleardoublepage

\input{../attachments/sponsorship.tex}
\cleardoublepage
\input{../attachments/CV.tex}
\cleardoublepage
