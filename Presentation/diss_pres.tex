...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{columns}
		\begin{column}{0.44\columnwidth}
				%\vspace{-1mm}
			\begin{block}{\scriptsize Approach} %{\scriptsize Principle}
				\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{columns}
		\begin{column}{0.38\columnwidth}
			%\vspace{-1mm}
			\begin{block}{\scriptsize Idealistic Approach}
     			   	\vspace{-4mm}
	    		        \begin{align*}
			...
			\begin{tikzpicture}[node distance = 1.3cm, auto]
                        	% draw nodes
				\node [block] (frame) {Time Allocation in Frame Structure};
  			        \node [block, below of=frame] (channelest) {Estimation of involved channels};
  			        \node [block, below of=channelest] (cdf) {Variations in performance parameter is characterized in terms of their cdfs)};
  			        \node [block, below of=cdf] (tradeoff) {Derived expressions are used to characterize the performance tradeoff};
				% draw edges
		...
		\begin{center}
			...
			\begin{tikzpicture}[scale=1]
				\node[anchor=south west,inner sep=0] (image) at (0,0)
				{
					\includegraphics[width = 1.15\columnwidth]{../kapitel03/figures/Frame_Structure.ps}     
				};
			\end{tikzpicture}	
                        \end{overlayarea}
			\vspace{-0.5mm}
			...
			\only<1>
			{	
				\begin{block}{\scriptsize Achievable secondary throughput -- Average Constraint (AC)} 
                               	 \vspace{-3.2mm}
					\begin{align*}
...
\text{s.t.} & \text{ }  0 < \test \le \tsen \le T
			...
			\only<2->
			{	
				\begin{block}{\scriptsize Achievable secondary throughput -- Average Constraint (OC)} 
                               	 \vspace{-3.2mm}
					\begin{align*}
					\trsac(\ttest, \ttsenac) =& \maxi_{\test, \tsen} \e{\epd, \ecz, \eco}{\rs(\test, \tsen)},	\\	
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{center}
			...
			\node[anchor=south west,inner sep=0] (image) at (0,0)
			{
				\includegraphics[width = 0.7\columnwidth]{../kapitel03/figures/Frame_Structure.ps}     
			};
		\end{tikzpicture}	
	\end{center}
\end{frame}
	...
	\begin{columns}
		...
		\begin{center}
			...
			%Interweave Scenario \\\vspace{0.2cm} 
				...
				\node[anchor=south west,inner sep=0] (image) at (0,0)
				{
					\includegraphics[width = .85 \columnwidth]{../kapitel04/figures/CR_Scenario_Underlay}	     
				};
				\only<1>
				{
					%\fill[opacity = 0.2, fill = blue] (.32,1.16) rectangle (1.22,1.8);
			...
			\begin{tikzpicture}[scale=1]
				\node[anchor=south west,inner sep=0] (image) at (0,0)
				{
					\includegraphics[width = 1.1 \columnwidth]{../kapitel04/figures/Frame_Structure.ps}     
				};
			\end{tikzpicture}	
		\end{center}
		\end{column}
