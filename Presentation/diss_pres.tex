...
\tikzstyle{block} = [rectangle, draw, fill=kit-green50, 
    text width=18em, text centered, rounded corners, minimum height=5.5em]
...
%\pnote{This work is focussed on providing spectrum extension by promoting CR communications} 
	...
	\begin{center}
		...
		{
			\begin{block}{}
			A Cognitive Radio (CR) is an agile system that facilitates an efficient usage (secondary access) of the spectrum  
			\end{block}
		}
	\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{block}{\scriptsize Challenges}
		\begin{itemize}
			\item Involves the coexistence of two different systems: {\color{blue}{primary (licensed)}} and {\color{red}{secondary (unlicensed)}} 
		...
		\begin{column}{0.37\columnwidth}
			\onslide<2->
			{
				\begin{block}{\scriptsize Performance characterization}
					Secondary access is enabled through the employment of CR techniques at ST%, a CR system guarantees
				\begin{itemize}
		...
		\begin{column}[t]{0.53\columnwidth}
			\centering Challenges: \\[-0.2em]
				...
				\begin{block}{\scriptsize System design aspects?} %of incorporating channel estimation on the performance
					\begin{itemize} 
						\item handling the induced variations 
				...
				\begin{block}{\scriptsize Estimation technique?} %{\scriptsize Challenges}
					...
					\begin{itemize}
						...
						\item Look for techniques must offer low-complexity and versatility towards unknown primary user signals
					\end{itemize}
				\end{block}
				}
				\vspace{-1.1mm}
				...
				\begin{block}{\scriptsize Hardware Feasibility?}%{\scriptsize Channel knowledge}
					...
					\item Feasibility of the propositions under realistic situations? 
					\end{itemize}	
				\end{block}
				}
		\end{column}
	...
	\begin{columns}
		\begin{column}{0.45\columnwidth}
			...
			\begin{block}{\scriptsize Simplifications/Modifications} 
				\begin{itemize}
					\item Channel estimation is restricted to $\phpth$ $\Rightarrow$ Interference constraint
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\fs{7}{9}
		\begin{itemize}	
			...
			\item Channel knowledge is extremely necessary for the realization of CR techniques over the hardware, allowing secondary systems to coexists with the primary system 
			\item An analytical framework is proposed that captures the detrimental effects (time allocation and variations) due to imperfect channel knowledge  
