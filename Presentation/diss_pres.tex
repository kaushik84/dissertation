...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[t]{Performance Analysis}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\fs{7}{8}
	\begin{block}{}%{\scriptsize Performance Analysis}
		\begin{itemize}
			% Performance anlysis us determine the hardware feasibility of a wireless system 
			\item CR system involves the coexistence of two different system: {\color{blue}{primary}} and {\color{red}{secondary}}  
			\item Objective is ensure the interference at PR below a certain value 
		\end{itemize}
	\end{block}
	\begin{columns}
		\begin{column}{0.37\columnwidth}
			\begin{block}{\scriptsize Performance characterization}
				\begin{itemize}
					\item Interference at PR 
					\item Throughput at SR 
				\end{itemize}
			\end{block}
		\end{column}
		\begin{column}{0.63\columnwidth}
		...
		\begin{center}
			...
			{\color{blue}{PT, PR}}, \color{red}{ST($\Leftrightarrow$ CSC-BS) and SR($\Leftrightarrow$ MS)}\\\vspace{0.4cm} 
        		\begin{tikzpicture}[scale=1]
				\node[anchor=south west,inner sep=0] (image) at (0,0)
				{
