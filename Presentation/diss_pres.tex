...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{block}{\scriptsize Challenges}
		\begin{itemize}
			...
			\item Involves the estimation of the channels between two different systems $\Rightarrow$ conventional techniques? 
			\item  
		\end{itemize}
	\end{block}
	\begin{columns}
		\begin{column}{0.37\columnwidth}
			%\onslide<2->
			{
				\begin{block}{\scriptsize Impact on performance} %of incorporating channel estimation on the performance
					\begin{itemize} 
						\item Time allocation $\Rightarrow$ throughput at SR 
						\item Variations $\Rightarrow$ uncertain interference at PR 
					\end{itemize}
				\end{block}
			}
			%\onslide<3->
