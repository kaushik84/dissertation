	...
	\begin{columns}
		...
		\begin{center}
                        ...
                        \only<2>
			{
				...
				\node[anchor=south west,inner sep=0] (image) at (0,0)
				{
     					\includegraphics[width= 1.2 \columnwidth]{../kapitel04/figures/fig_opt_thr_vs_SNR_AWGN_SI_00}
				};
				\begin{scope}[x={(image.south east)},y={(image.north west)}]
		...
		\begin{center}
                        ...
                        \only<1>
			{
				...
				%	%% Add psfrag entries
					...
					\node[anchor=south west,inner sep=0] (image) at (0,0)
					{
						\includegraphics[width= 1.2\columnwidth]{../kapitel05/figures/fig_opt_cont_power_vs_SNR_AWGN}
					};
					\begin{scope}[x={(image.south east)},y={(image.north west)}]
					...
					\draw[black,thick,<->] (0.11,0.18) --  node[below, font=\footnotesize] {Regime III} (0.385,0.18);
		               		...
		               		\node[draw=none,fill=kit-green30, minimum height = 0.6cm, align = center, font = \footnotesize] at (0.5, 1.05) {Controlled power versus channel gain $\phpth$};
					%\draw[help lines,xstep=.1,ystep=.1] (0,0) grid (1,1);
					%\foreach \x in {0,1,...,9} { \node [anchor=north] at (\x/10,0) {0.\x}; }
					%\foreach \y in {0,1,...,9} { \node [anchor=east] at (0,\y/10) {0.\y}; }
					\end{scope}
                        ...
                        \only<2->
			{
				\begin{tikzpicture}[scale=1]
					...
					\node[anchor=south west,inner sep=0] (image) at (0,0)
					{
						\includegraphics[width= 1.2\columnwidth]{../kapitel05/figures/fig_opt_thr_vs_SNR_AWGN}
					};
					\begin{scope}[x={(image.south east)},y={(image.north west)}]
					\draw[black,thick,<->] (0.82,0.18) --  node[below, font=\footnotesize] {Regime I} (0.955,0.18);
					\draw[black,thick,<->] (0.39,0.18) --  node[below, font=\footnotesize] {Regime II} (0.815,0.18);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[c]{Hardware Validation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{columns}
		\begin{column}{0.45\columnwidth}
			\fs{7}{8}
			...
			\begin{tikzpicture}[scale=1]
				\node[anchor=south west,inner sep=0] (image) at (0,0)
            		    	{
               		        	\includegraphics[width=1.2 \columnwidth]{../kapitel06/figures/ValidationSetUp.ps}
                		};
		...
		\begin{column}{0.45\columnwidth}
			...
			\centering
				...
				\input{figures/P_PR_Rx}
                		...
                		\node[anchor=south west,inner sep=0] (image) at (0,0)
          		        {
                        		\includegraphics[width=1.2\columnwidth]{figures/P_PR_Rx}
            		        };
			...
			\vspace{2mm}	
             	        ...
             	        \resizebox{.95 \columnwidth}{!}{%
				\input{figures/R_s}
			        \includegraphics[width=1.2\columnwidth]{figures/R_s}%
			}
		\end{column}
		\begin{column}{0.55\columnwidth}
		\fs{7}{8}
		...
		\centering
			\input{../kapitel06/figures/ETT.tex}
		        \begin{tikzpicture}[scale=1]
       				\node[anchor=south west,inner sep=0] (image) at (0,0)
        			{
                			\includegraphics[width=1.2 \columnwidth]{../kapitel06/figures/ETT}
        			};
        			\begin{scope}[x={(image.south east)},y={(image.north west)}]
