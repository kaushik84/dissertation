...
\pnote{However, an spectrum extension is envisioned as power source that is capable of sustaining the desired areal capacity for 5G}
\pnote{Due to the static allocation of the spectrum below 6 GHz to different mobile services, it is difficult spectrum below 6 GHz. In this perspective, two alternatives exists: either look for spectrum at higher frequencies beyond 6 GHz, which corresponds to mm-W and visible light communications or increase the spectrum efficiency of spectrum existing below 6 GHz}
...
\pnote{This work is focussed on providing spectrum extension by promoting CR communications} 
	...
	\begin{center}
		...
		{
			\begin{block}{}
			A Cognitive Radio (CR) is an agile system that allows efficient usage (secondary access) of the spectrum below $\SI{6}{GHz}$ 
			\end{block}
		}
	\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pnote{Performance analysis in context to wireless system has two main objectives, 1) it help us understand the feasibility of a wireless system in real or close to real conditions. Secondly, it allows us to determine the performance limits.} 
