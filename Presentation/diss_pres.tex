			...
			\centering Challenges: \\
				...
				\begin{block}{\scriptsize Estimation Technique?} %{\scriptsize Challenges}
					...
					% There exits a multitude of wireless standards that can act as primary system, it is difficult to included a dedicated circuitry for each primary user signal 
						...
						\item Conventional techniques fail 
					\end{itemize}
				\end{block}
				\vspace{-1.1mm}
				\begin{block}{\scriptsize Impact on performance} %of incorporating channel estimation on the performance
					\begin{itemize} 
						\item Time allocation for channel estimation 
						\item Variations induced due to imperfect knowledge 
						%\item Channel fading 
					\end{itemize}
				\end{block}
				\vspace{-1.1mm}
				\begin{block}{\scriptsize Performance degradation}%{\scriptsize Channel knowledge}
					\begin{itemize}
						\item Level degradation in the performance? 
						\item Measures to reduce this degradation
					\end{itemize} 
				\end{block}
				\vspace{-1.1mm}
				\begin{block}{\scriptsize Hardware Feasibility}%{\scriptsize Channel knowledge}
					\begin{itemize}
					\item Validating the assumptions 
					\item Justify the applicability of proposed framework in realistic scenarios 
					\end{itemize}	
				\end{block}
		\end{column}
		...
		\begin{column}[t]{0.4\columnwidth}
			...
			\begin{block}{}%{\scriptsize Hardware Feasibility}%{\scriptsize Channel knowledge}
				\begin{itemize}
					...
					\item Operation of a CR system over the hardware 
					\end{itemize}	
				\end{block}
		\end{column}
	\end{columns}
