...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pnote{Interweave system enable coexistence by operating the primary and secondary system in temporal domain} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pnote{It is essential as-well-as challenging to depict their hardware implementation of CR systems}
	...
	\pnote{Channel estimation was restricted to the channel hp3. The main purpose here is to demonstrate the applicability of the interference constraint}
	...
	\pnote{The modified version of the deployment scenario and the frame structure is illustrated in the figures}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\pnote{Firstly, a hardware validation of derived expressions is proposed} 
	\pnote{To perform the validation process, the following measurement setup was used}
	\pnote{The signal generator was modelled as PR for transmitting signals}
	...
	\pnote{An SDR platform emulates the ST that realizes channel estimation, the power control and data transmission (to a virtual SR because channel knowledge is assumed to be perfect)}
...
\begin{frame}[c]{Validation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\pnote{Based the measurement parameters illustrated in the table, the pdfs of performance parameters obtained using the theoretical expressions are compared with the histograms computed from the measurements}
	...
	\pnote{Finally, the figure justifies the applicability of estimation throughput tradeoff yielding an achievable throughput for a desired value of confidence probability constraint}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\pnote{The PR sends a pilot signal over the USRP, the SDR platform -> received by other USRP acting as ST -> pre-processing to remove effects such as DC offset and flickering noise}
		\pnote{Channel estimation is employed and upon applying the interference constraint --> power control is employed --> data signal is transmitted over the USRP and received by the first USRP --> which computes the actual power received --> compute the actual confidence probability --> verify if the constraint is applicable} 
		\fs{7}{8}
		\centering
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pnote{Upon starting the demonstrators, the following observed: 1) the received power at the PR is rightly below the interference threshold --> This conveys that received power estimation followed by power control are functioning at the ST as expected}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\fs{7}{9}
		\begin{itemize}	
			...
			\item An analytical framework is proposed that characterizes the detrimental effects (time allocation and channel variations) due to channel estimation 
