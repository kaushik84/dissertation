...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pnote{It is worthy to note that the secondary throughput is dependent on the estimation time directly through the resouce allocation and indirectly through the control power (seen in previous slide).}
	...
	\pnote{Next, the variation of the acheivable throughput is compared with the SNR received at ST over the channel hp3 for the IM, EM. Coro2 represents the EM but without power control} 
	...
	\pnote{The operation range where the benifits from US can be procured (operating under low SNR of US) is highly dependent on transmit power}  
	%\vspace{-4.5mm}
	\fs{7}{8}
	\begin{columns}
		\begin{column}{0.45\columnwidth}
