...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pnote{The ST detects the presence and absence of primary user signal by listening to the PT. In this way, the ST protects the PR, by not transmitting its own signal whenever the primary user signal is detected.} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pnote{Now, to employ power control, the ST listens to signals transmitted by the PR, apply channel reciprocity and control its transmit power so that the interference received at PR is below a certain threshold.} 
	...
	\begin{block}{}%{\scriptsize Power control} 
		...
		\begin{align*}
			...
			\begin{cases} 
				...
				\end{cases} \\
				\text{where  } \apo &= \frac{{\color{kit-green100}{\test \fsam}} (1 + {\color{kit-green100}{\snrrcvdu}})^2}{2 + 4 {\color{black}{\snrrcvdu}}} \text{ and } \bpo = \frac{\nps (2 + 4 {\color{black}{\snrrcvdu}})}{{\color{kit-green100}{\test \fsam}} (1 + {\color{black}{\snrrcvdu}})},
			\end{align*}
	\end{block}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pnote{The variations in the system are characterized in terms of the interference received at the PR and the throughput at SR}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pnote{An SDR platform emulates the ST that realizes the power control and data transmission to a virtual SR because channel knowledge is assumed to be perfect}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pnote{Finally, the figure justifies the applicability of optimization problem yielding an achievable throughput}
	...
	\pnote{The time interval at which the confidence probability constraint is satisfied yields th maximum expected throughput} 
	\begin{columns}
		\begin{column}{0.45\columnwidth}
			\fs{7}{8}
			\centering
