...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\pnote{Next, we discuss performance analysis from the perspective of CR systems, namely, interweave system}
	...
	\begin{column}{0.63\columnwidth}
		...
		\begin{center}
			CSC in a preliminary 5G network \\\vspace{0.4cm} 
				...
				\node[anchor=south west,inner sep=0] (image) at (0,0)
				{
					\includegraphics[width = \columnwidth]{../kapitel01/figures/Cellular_Scenario_CR_T6}	     
				};
				\only<1>
				{

					\fill[opacity = 0.2, fill = red] (1.58,1.32) rectangle (2.7,2.16);
				}
				\only<2>
				{
					\fill[opacity = 0.2, fill = blue] (1.05,2.01) rectangle (1.75,2.7);
					\fill[opacity = 0.2, fill = kit-green100] (2.1,.6) rectangle (3.05,1.2);
					\fill[opacity = 0.2, fill = red] (4.38,2.77) rectangle (4.94,3.8);
				}
				\only<3>
				{
					\fill[opacity = 0.2, fill = red] (1.58,1.32) rectangle (2.7,2.16);
					\fill[opacity = 0.2, fill = blue] (3.45,3.25) rectangle (4.65,3.65);
	...
	\begin{columns}
		...
		\begin{center}
			...
			{\color{blue}{PT, PR}}, \color{red}{ST($\Leftrightarrow$ CSC-BS) and SR($\Leftrightarrow$ MS)}\\\vspace{0.2cm} 
				...
				\only<2>
				{
					\fill[opacity = 0.2, fill = blue] (.32,1.16) rectangle (1.22,1.8); %PR
					\fill[opacity = 0.2, fill = red] (3.65,1.18) rectangle (4.65,1.6); %ST
					\fill[opacity = 0.2, fill = red] (2.42,2.3) rectangle (3.88,3.08); %SR
	...
	\begin{columns}
		...
		\begin{center}
			...
			\begin{overlayarea}{\textwidth}{4.2cm}
				...
				\node[anchor=south west,inner sep=0] (image) at (0,0)
				{
					\includegraphics[width =  \columnwidth]{../kapitel04/figures/CR_Scenario_Underlay}	     
				};
				\only<2->
				{
