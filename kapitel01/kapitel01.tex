...
In context with a CR system, the channel knowledge, unlike conventional or state-of-the-art wireless systems, is not confined to a single transmitter-receiver link, rather it includes all the related channels that exist within as-well-as across the primary and the secondary systems. Now, since the performance of CR system jointly depends on these two systems, the channel knowledge is a paramount for the performance characterization. Despite significant advancement towards performance characterization that examined in the literature, its performance with regard to the channel estimation has never been understood. Especially, the absence of this knowledge renders the performance characterization of a CR system incomplete and inappropriate for practical implementations. Curtailing this gap, this thesis, capitalizes on the estimation of the involved channel in the CR systems. In other words, making the channel knowledge accessible at the CSC-BS, enables it to implement cognitive techniques for the CR communication with the MS, without exceeding the desired level of interference at the PR. 

Now, with the inclusion of channel estimation,  
